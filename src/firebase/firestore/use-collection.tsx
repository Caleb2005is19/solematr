 ...
 * 
 *
 * IMPORTANT! It is highly recommended to memoize the `targetRefOrQuery` with `useMemo` or `useMemoFirebase`
 * to prevent unnecessary re-renders and potential infinite loops.
 *  
